...
<head>
  ...
  <link href="<?php echo web_root;?>plugins/homepage/assets/css/styles.css" rel="stylesheet">
            ...
            <div class="navigation">
              <nav>
                <ul class="nav topnav">
                  ...
                  <li>
                    <a href="<?php echo web_root; ?>index.php?q=about"><i class="fas fa-info-circle"></i> About Us</a>
                  </li> 
                  <li>
                    <a href="<?php echo web_root; ?>index.php?q=contact"><i class="fas fa-envelope"></i> Contact Us</a>
                  </li>
                  <li>
