...
<head>
    <head>
        ...
        <link rel="icon" type="image" href="http://localhost:8080/e-learningsystem/admin/adminMenu/images/logo-round.png" />
            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="#">Brainboost E-Learning Academy </a>
                    <div class="nav-collapse collapse navbar-inverse-collapse">
                        ...
                        <ul class="nav pull-right">
                            ...
                            <li class="nav-user dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="http://localhost:8080/e-learningsystem/admin/adminMenu/images/user.png" class="nav-avatar" />
                                <b class="caret"></b></a>
                                <ul class="dropdown-menu">
        ...
        <div class="copyright">
            <div class="row">
                <div class="footer-bottom">
                    <p style="text-align:center;">© 2024 Raini Wijewantha | All rights reserved.</p>
                </div>
            </div>
        </div>
    </div>
